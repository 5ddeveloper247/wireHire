          ...
          <div class="row m-0">
            ...
            <div class="col-md-12">
              <div class="tablebox">
                ...
                <button class="btn shoot2 float-end bgcolor text-white my-3 mx-3" > Add </button>
                ...
                <table class="table table-responsive border" id="example">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('fsu_admin_specific_job1')}}" class="btn bt-sm" style="background-color : #1d1c47;color : white;">Detail</a>
                      </td>
                    </tr>
...
<form id="sendJobPosition_form" action="{{route('job_position')}}" method="post">
@csrf
