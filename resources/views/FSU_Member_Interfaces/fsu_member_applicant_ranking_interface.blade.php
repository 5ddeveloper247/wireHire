              ...
              <table class="table table-responsive border" id="example">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>CIS</td>
                    <td>CCSIT</td>
                    <td><a class="text-decoration-none" href="{{route('fsu_member_profile_interface1')}}">View
                        Profile</a></td>
                    <td class="text-center ankar bg-succes">
                  ...
                  <tr>
                    ...
                    <td>CIS</td>
                    <td>CCSIT</td>
                    <td><a class="text-decoration-none" href="FSU Member Candidate Profile Interface 1.html">View
                        Profile</a></td>
                    <td class="text-center ankar bg-succes">
                      <i class="fi fi-rr-plus"></i>
                    </td>
